...
```bash
mkdir -p skills/project-system-design
```

### 2. 创建 SKILL.md

```bash
touch skills/project-system-design/SKILL.md
```

### 3. 添加参考资料

```bash
mkdir -p skills/project-system-design/references
```
...
```bash
mkdir -p skills/project-system-design/scripts
```
...
```bash
node /path/to/software-project-training-docs/course_design/bin/install.js --dry-run
```

### 5. 执行本地安装

```bash
node /path/to/software-project-training-docs/course_design/bin/install.js
```
...
```bash
node /path/to/software-project-training-docs/course_design/bin/install.js --uninstall
```
