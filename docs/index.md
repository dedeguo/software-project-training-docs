...
[查看 16 周项目路线 🗺️](guide/roadmap.md){ .md-button .md-button--primary }
...
| 有兴趣 | 听得懂 | 做得出来 | 有成就感 |
| :---: | :---: | :---: | :---: |
| 选择与校园、生活、行业或个人发展有关的真实项目 | 先看成果、再拆任务，只学习当前项目真正需要的知识 | 有脚手架、任务单、示例、AI 助教和阶段验收提供支持 | 每周看到进展，最终完成部署、路演和作品展示 |
...
![项目成长路线](./assets/imgs/项目成长路线.png){ width="100%" .shadow }

| 阶段 | 主要任务 | 阶段成果 |
| :--- | :--- | :--- |
| 第 1—4 周 | AI 编程体验、选题、需求和系统设计 | 立项书、需求文档、原型和设计方案 |
| 第 5—8 周 | 搭建项目、完成登录及第一个核心模块 | 可运行项目骨架和中期演示版本 |
| 第 9—12 周 | 完成核心业务流程，增加特色功能 | 完整业务闭环和项目特色 |
| 第 13—15 周 | 测试、修复、优化、部署和成果包装 | 可访问项目、测试报告、README 和演示材料 |
...
[查看项目选题与范围控制方法](chapter02/01-topic-research.md){ .md-button }
...
1. 向 AI 说明项目背景、技术环境、已有代码和验收标准；
2. 将复杂功能拆分成能够逐步验证的小任务；
3. 阅读、运行、测试并修改 AI 生成的代码；
...
!!! info "先修知识"
    本教程不重复系统讲授 Java Web 基础。遇到相关知识，可以查阅[《Java Web 开发技术》电子教材](https://javaweb.chende.top/)。
